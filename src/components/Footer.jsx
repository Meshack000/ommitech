...
function Footer() {
    return (
        <footer className="flex flex-col items-center justify-center w-full py-16  h-120 text-sm" style={{ backgroundColor: '#0a0f2c' }}>

            {/* Logo / Brand */}
            <h2 className="text-white text-2xl font-bold tracking-widest uppercase mb-2">Ommitech</h2>
            <p className="text-gray-400 text-xs tracking-wider mb-8">Software & IT Solutions · Ghana</p>
            ...
            {/* Social Icons */}
            <div className="flex items-center gap-5 text-gray-400 mb-10">
                <a href="#" className="hover:text-white hover:-translate-y-0.5 transition-all duration-300">
            ...
            {/* Divider */}
            <div className="w-full max-w-4xl border-t border-white/10 mb-8" />

            {/* Copyright */}
            <p className="text-gray-500 text-xs text-center">
                © 2026 Ommitech. All rights reserved. · Built in Ghana - Kumasi
            </p>
        </footer>
    )
}
